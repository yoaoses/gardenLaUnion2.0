...
export default async function HomePage() {
  // Cargar toda la configuración del sitio en una sola query
  const config = await getConfig();

  // Extraer datos para cada sección
  ...
  const sellos = [
    ...
    {
      titulo: config["sellos.formacion_cristiana.titulo"] || "Formación Cristiana",
