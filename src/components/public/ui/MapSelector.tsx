  ...
  return (
    <div className={className}>
      ...
      <div
        ...
        style={{
          opacity: sheetOpen ? 1 : 0,
          transform: sheetOpen ? "scale(1)" : "scale(0.95)",
        ...
        >
          ...
          <div className="flex items-start justify-between mb-1">
            ...
            <button
              onClick={() => setSheetOpen(false)}
              aria-label="Cerrar"
              className="w-8 h-8 rounded-full bg-gc-gray-100 flex items-center justify-center shrink-0 hover:bg-gc-gray-200 transition-colors duration-200"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="text-gc-gray-700">
                <path d="M18 6L6 18M6 6l12 12" />
              </svg>
            </button>
          </div>

          <p className="text-sm text-gc-gray-400 mb-5">{direccion}</p>
          ...
          <button
            onClick={() => setSheetOpen(false)}
            className="w-full mt-4 py-3 rounded-xl border border-gc-gray-200 bg-gc-gray-100 text-gc-gray-700 font-body font-semibold text-sm hover:bg-gc-gray-200 transition-colors duration-200 min-h-[44px]"
          >
            Cancelar
          </button>
        </div>
