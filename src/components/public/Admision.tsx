          ...
          <div className="card p-8 lg:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-gc-navy/70 font-body leading-relaxed mb-6">
                  {info}
                </p>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item} className="flex items-start gap-3">
                      ...
                      <span className="text-gc-navy/70 font-body text-sm">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-gc-navy/5 flex items-center justify-center mx-auto mb-6">
                  <svg className="w-10 h-10 text-gc-navy/40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-xs text-gc-navy/30 font-body mt-3">
