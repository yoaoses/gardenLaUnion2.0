    ...
    <section id="quienes-somos" className="py-12 sm:py-16 lg:py-20 xl:py-28">
      <div className="container-gc">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start max-w-6xl mx-auto">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="card p-8 mb-4">
              <div className="w-12 h-12 rounded-2xl bg-gc-gold/10 flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-gc-gold-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="text-xl font-display font-bold text-gc-green-800 mb-4">Misión</h3>
            ...
            <div className="card p-8">
              <div className="w-12 h-12 rounded-2xl bg-gc-green/10 flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-gc-green-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
              ...
              <h3 className="text-xl font-display font-bold text-gc-green-800 mb-4">Visión</h3>
          ...
          {/* Columna foto (order-1 en mobile → va arriba) */}
          <div className="order-1 lg:order-2 lg:sticky lg:top-24">
            <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-[4/3]">
              <Image
                src="https://picsum.photos/seed/garden-somos/800/600"
                alt="Estudiantes de Garden College"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 50vw"
              />
              {/* Overlay sutil con degradado */}
              <div className="absolute inset-0 bg-gradient-to-t from-gc-green-900/30 to-transparent" />
            </div>
          </div>
