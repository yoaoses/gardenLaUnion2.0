        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-2 space-y-6">
            {sedes.map((sede) => (
              <div
                key={sede.nombre}
                className="p-6 bg-gc-cream rounded-2xl"
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-3">
                    <svg
                      className="w-5 h-5 text-gc-gold-dark mt-0.5 shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                    ...
                    <span className="text-gc-navy/70 font-body text-sm">
                      {sede.direccion}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg
                      className="w-5 h-5 text-gc-gold-dark shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
